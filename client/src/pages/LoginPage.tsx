...
<div style={{ marginTop: 16 }}>
  ...
  {/* Google button */}
  <a href={`${BACKEND_URL}/api/auth/google`} style={{ textDecoration: 'none' }}>
    <button type="button" style={{
      width: '100%', padding: '11px', borderRadius: 10,
      border: '1px solid rgba(124,138,165,0.2)',
      background: 'rgba(255,255,255,0.03)',
      color: '#EAF2FF', fontSize: 14, fontWeight: 500,
      ...
      onMouseEnter={e => {
        (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(76,124,255,0.4)'
        ;(e.currentTarget as HTMLButtonElement).style.background = 'rgba(76,124,255,0.06)'
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(124,138,165,0.2)'
